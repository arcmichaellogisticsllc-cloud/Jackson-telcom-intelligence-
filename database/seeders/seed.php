...
if (in_array($seedMode, ['production', 'minimal'], true)) {
    ...
    $db->commit();
    echo "Seeded minimal production baseline: regions, users, capacity targets, and executive doctrine. No demo acquisition data was inserted.\n";
    exit;
}
