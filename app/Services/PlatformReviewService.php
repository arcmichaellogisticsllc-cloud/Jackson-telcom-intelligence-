...
class PlatformReviewService
{
    ...
    private function buildHealthChecks(PDO $db): void
    {
        $checks = [
            ...
            ['Navigation', 'Complexity', max(0, $this->count($db, 'SELECT COUNT(*) FROM recommended_actions WHERE status = "Open"') - 200), 'Too many open findings make the platform feel like 500 things.', 'Use Executive Operating View and perspective filters to focus the next 5 actions.'],
        ];
    ...
    private function buildOperatorModes(PDO $db): void
    {
        ...
        $rows = [
            ...
            ['Relationship / Opportunity Perspective', 'Emphasize accounts, relationships, opportunities, market intelligence, and partnerships without creating a separate workflow.', '/command/southeast', 'Company State, My Priorities, Shared Priorities, Company Priorities', 'Top relationships, work-ready organizations, account gaps, market actions', 'Open the Command Center, complete owner-specific and shared actions, and record outcomes.'],
            ['Capacity / Readiness Perspective', 'Emphasize capacity, subcontractors, workforce, field readiness, and handoff readiness without creating a separate workflow.', '/command/great-lakes', 'Company State, My Priorities, Shared Priorities, Company Priorities', 'Capacity gaps, workforce signals, readiness blockers, SyncERP handoffs', 'Open the Command Center, complete owner-specific and shared actions, and record outcomes.'],
