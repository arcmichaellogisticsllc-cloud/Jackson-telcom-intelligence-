...
class OperationalMaturityService
{
    ...
    {
        $rows = [
            ['Mike Daily Executive Review','Daily','Executive Brief Review','Mike','Southeast','Top 5 Actions, Capacity Gap, Relationship Risk, Pursuits','Weekday','08:00'],
            ['Ron Daily Executive Review','Daily','Executive Brief Review','Ron','Great Lakes','Top 5 Actions, Capacity Gap, Relationship Risk, Pursuits','Weekday','08:00'],
            ['Southeast Weekly Capacity Review','Weekly','Capacity Review','Mike','Southeast','Capacity gaps, subcontractor pipeline, approved network, blockers','Monday','09:00'],
            ['Great Lakes Weekly Relationship Review','Weekly','Relationship Review','Ron','Great Lakes','Project managers, utility access, prime access, relationship risks','Tuesday','09:00'],
            ['Southwest Shared Monthly Readiness Review','Monthly','Regional Readiness Review','Mike/Ron Shared','Southwest','Houston coverage, underground capacity, utility relationships, demand','First Monday','10:00'],
            ['Monthly Strategic Account Review','Monthly','Strategic Account Review','Admin','National','Comcast, Charter, Frontier, AT&T, Windstream, co-ops','First Wednesday','11:00'],
            ['Monthly Workforce Review','Monthly','Workforce Review','Admin','National','Movers, recruitability, emerging leaders, talent gaps','Second Wednesday','11:00'],
            ['Monthly Competitive Review','Monthly','Competitive Review','Admin','National','Hiring spikes, awards, market entry, win/loss','Third Wednesday','11:00'],
            ['Quarterly Regional Dominance Review','Quarterly','Regional Dominance Review','Admin','National','Dominance score, expansion, investment priorities, account coverage','Quarter Start','13:00'],
        ];
