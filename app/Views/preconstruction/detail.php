...
$recordPrimaryOwner = $profile['primary_owner'] ?? $recordOwner;
$recordSecondaryOwner = $profile['secondary_owner'] ?? '';
$recordSharedOwnerFlag = (int)($profile['shared_owner_flag'] ?? 0);
$recordOwnershipNotes = $profile['ownership_notes'] ?? '';
