...
$recordPrimaryOwner = $package['primary_owner'] ?? $recordOwner;
$recordSecondaryOwner = $package['secondary_owner'] ?? '';
$recordSharedOwnerFlag = (int)($package['shared_owner_flag'] ?? 0);
$recordOwnershipNotes = $package['ownership_notes'] ?? '';
