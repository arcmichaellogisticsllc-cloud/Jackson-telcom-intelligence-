...
$recordPrimaryOwner = $account['primary_owner'] ?? $recordOwner;
$recordSecondaryOwner = $account['secondary_owner'] ?? '';
$recordSharedOwnerFlag = (int)($account['shared_owner_flag'] ?? 0);
$recordOwnershipNotes = $account['ownership_notes'] ?? '';
