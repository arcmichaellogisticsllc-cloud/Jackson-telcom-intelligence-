  ...
  <aside class="sidebar">
    ...
    <nav>
      ...
      $navGroups = [
        ...
        'SYSTEM' => ['/settings' => 'Settings','/operating-rhythm' => 'Operating Rhythm','/platform-review' => 'Platform Health','/activities' => 'Activities','/recommendations' => 'Recommendations','/warehouse' => 'Intelligence Warehouse'],
      ];
      ?>
