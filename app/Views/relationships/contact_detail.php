...
$recordPrimaryOwner = $contact['primary_owner'] ?? $recordOwner;
$recordSecondaryOwner = $contact['secondary_owner'] ?? '';
$recordSharedOwnerFlag = (int)($contact['shared_owner_flag'] ?? 0);
$recordOwnershipNotes = $contact['ownership_notes'] ?? '';
