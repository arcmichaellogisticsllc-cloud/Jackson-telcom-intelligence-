...
<?php $why='Strategic accounts control repeat work, account influence, and future fiber backbone opportunity volume.'; $recommended='Strengthen high-value accounts where relationship health or influence coverage is below the opportunity and capacity demand.'; $next='Open the weakest high-value account and assign a relationship action to Mike, Ron, or shared Southwest ownership.'; $risk='Weak account coverage lets competitors become the default path to work.'; require __DIR__ . '/../components/action_first.php'; ?>
<section class="panel">
