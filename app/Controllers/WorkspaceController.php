...
class WorkspaceController extends Controller
{
    private array $workspaceMeta = [
        ...
        'system' => ['SYSTEM', 'Health, settings, automation, integrity, and operating controls.', ['Settings' => '/settings', 'Operating Rhythm' => '/operating-rhythm', 'Administration' => '/platform-review', 'Operator Modes' => '/operator-modes', 'Recommendations' => '/recommendations', 'Intelligence Warehouse' => '/warehouse']],
    ];
