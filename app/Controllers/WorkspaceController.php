...
class WorkspaceController extends Controller
{
    private array $workspaceMeta = [
        ...
        'system' => ['SYSTEM', 'Health, settings, automation, integrity, and operating controls.', ['Settings' => '/settings', 'Production Readiness' => '/production-readiness', 'Operating Rhythm' => '/operating-rhythm', 'Decision Visuals' => '/decision-visuals', 'Administration' => '/platform-review', 'Operator Modes' => '/operator-modes', 'Recommendations' => '/recommendations', 'Intelligence Warehouse' => '/warehouse']],
    ];
